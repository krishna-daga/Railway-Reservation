...
<body>
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.php">INDIANRAILWAYS</a>
			</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
                    <th style="border-top:0px;"><label> Date </th>
